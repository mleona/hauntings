      ...
      <!-- Main content -->
        <div class="container">
            <ul class="nav nav-pills nav-fill" style="margin-top: 50px;">
                <li class="nav-item">
                    <a class="nav-link active" data-toggle="tab" href="#college_hall">College Hall</a>
                </li>

                <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#mery_berry">Mary Berry</a>
                </li>

                <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#millies">Millie's</a>
                </li>

                <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#cowles_gym">Cowles Gym</a>
                </li>
            </ul>

            <div id="myTabContent" class="tab-content">
                <div class="tab-pane fade show active" id="college_hall">
                	<div class="card" style="width: 18rem; float: right; margin-top: 1%; margin-left: 5%; margin-bottom: 2%;">
					  <img class="card-img-top" src="img/collegehall.jpg" alt="College Hall" data-toggle="modal" data-target="#enlargephoto">
					  <div class="card-body">
					    <p class="card-text">The exterior of College Hall. The seal can be seen in the pavement at the bottom of the photo.</p>
					    <p class="card-text"><small class="text-muted">Click the picture to enlarge.</small></p>
					  </div>
					</div>

					<div class="modal fade" id="enlargephoto" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
			 			<div class="modal-dialog modal-dialog-centered modal-lg" role="document">
					    <div class="modal-content">
					      <div class="modal-header">
					        <h5 class="modal-title" id="exampleModalLabel">College Hall</h5>
					        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
					          <span aria-hidden="true">&times;</span>
					        </button>
					      </div>
					      <div class="modal-body">
					      	<img class="rounded col-12" src="img/collegehall.jpg" alt="College Hall">
					      </div>
					    </div>
					  </div>
					</div>
                    ...
                    <h2>College Hall</h2>
                    <br>
					<h4>Paranormal Entity: Mildred Hedges</h4>
					...
					<br><br>
					<h4>Paranormal Entity: The Simpson College Seal</h4>
                    ...
                    <br><br>
                    <h4>Paranormal Entity: Derdlim Hedges</h4>
                    ...
                    <br>
                    <img src="img/bedroom.jpg" alt="Derdlim">
                </div>

                <div class="tab-pane fade" id="mery_berry">
     				<div class="card" style="width: 18rem; float: right; margin-top: 1%; margin-left: 5%; margin-bottom: 2%;">
					  <img class="card-img-top" src="img/marryberry.jpg" alt="Mery Berry" data-toggle="modal" data-target="#enlargephoto2">
					  <div class="card-body">
					    <p class="card-text">The exterior of Mary Berry. Mildred has been sighted staring out these windows.</p>
					     <p class="card-text"><small class="text-muted">Click the picture to enlarge.</small></p>
					  </div>
					</div>

					<div class="modal fade" id="enlargephoto2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel2" aria-hidden="true">
			 			<div class="modal-dialog modal-dialog-centered modal-lg" role="document">
					    <div class="modal-content">
					      <div class="modal-header">
					        <h5 class="modal-title" id="exampleModalLabel2">Mary Berry</h5>
					        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
					          <span aria-hidden="true">&times;</span>
					        </button>
					      </div>
					      <div class="modal-body">
					      	<img class="rounded col-12" src="img/marryberry.jpg" alt="Mary Berry">
					      </div>
					    </div>
					  </div>
					</div>
					
					 <div class="tab-pane fade" id="mary">
     				<div class="card" style="width: 18rem; float: right; margin-top: 1%; margin-left: 5%; margin-bottom: 2%;">
					  <img class="card-img-top" src="img/mary.jpg" alt="Mery Berry" data-toggle="modal" data-target="#enlargephoto9">
					  <div class="card-body">
					    <p class="card-text">The exterior of Mary Berry. Mildred has been sighted staring out these windows.</p>
					     <p class="card-text"><small class="text-muted">Click the picture to enlarge.</small></p>
					  </div>
					...
					<div class="modal fade" id="enlargephoto9" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel9" aria-hidden="true">
			 			<div class="modal-dialog modal-dialog-centered modal-lg" role="document">
					    <div class="modal-content">
					      <div class="modal-header">
					        <h5 class="modal-title" id="exampleModalLabel9">Mary Berry</h5>
					        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
					          <span aria-hidden="true">&times;</span>
					        </button>
					      </div>
					      <div class="modal-body">
					      	<img class="rounded col-12" src="img/mary.jpg" alt="Mary Berry">
					      </div>
					    </div>
					  </div>
					</div>
					...
					<br><br>
					<h4>Paranormal Entity: The Whiteboard of Room 120</h4>
                    ...
                    <br><br>
                    <h4>Unconfirmed Rumor: The Lower Level Women's Restroom</h4>
                ...
                <div class="tab-pane fade" id="millies">
              		<div class="card" style="width: 18rem; float: right; margin-top: 1%; margin-left: 5%; margin-bottom: 2%;">
					  <img class="card-img-top" src="img/millies.jpg" alt="Millie's" data-toggle="modal" data-target="#enlargephoto3">
					  <div class="card-body">
					    <p class="card-text">Millie's coffee shop. Named after Mildred Hedges.</p>
					     <p class="card-text"><small class="text-muted">Click the picture to enlarge.</small></p>
					  </div>
					</div>

					<div class="modal fade" id="enlargephoto3" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel3" aria-hidden="true">
			 			<div class="modal-dialog modal-dialog-centered modal-lg" role="document">
					    <div class="modal-content">
					      <div class="modal-header">
					        <h5 class="modal-title" id="exampleModalLabel3">Millie's</h5>
					        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
					          <span aria-hidden="true">&times;</span>
					        </button>
					      </div>
					      <div class="modal-body">
					      	<img class="rounded col-12" src="img/millies.jpg" alt="Millie's">
					      </div>
					    </div>
					  </div>
					</div>
                    ...
                    <h2>Millie's</h2>
                    <br>
					<h4>Paranormal Entity: Albert</h4>
					...
					<br><br>
					<h4>Unconfirmed Rumor: Flickering Lights</h4>
                ...
                <div class="tab-pane fade" id="cowles_gym">
                	<br>
					<div class="alert alert-danger alert-dismissible fade show" role="alert">
					  <strong>Warning!</strong> The paranormal entities that reside in Cowles Gym are potentially dangerous. Do not enter the building alone at night.
              		...
              		<div class="card" style="width: 18rem; float: right; margin-top: 1%; margin-left: 5%; margin-bottom: 2%;">
					  <img class="card-img-top" src="img/cowlesgym.jpg" alt="Cowles Gym" data-toggle="modal" data-target="#enlargephoto4">
					  <div class="card-body">
					    <p class="card-text">The anomalous softball closet found within Cowles Gym.</p>
					     <p class="card-text"><small class="text-muted">Click the picture to enlarge.</small></p>
					  </div>
					</div>


					<div class="modal fade" id="enlargephoto4" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel4" aria-hidden="true">
			 			<div class="modal-dialog modal-dialog-centered modal-lg" role="document">
					    <div class="modal-content">
					      <div class="modal-header">
					        <h5 class="modal-title" id="exampleModalLabel4">Cowles Gym</h5>
					        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
					          <span aria-hidden="true">&times;</span>
					        </button>
					      </div>
					      <div class="modal-body">
					      	<img class="rounded col-12" src="img/cowlesgym.jpg" alt="Cowles Gym">
					      </div>
					    </div>
					  </div>
					</div>
                	...
                	<br>
                	<h2>Cowles Gym</h2>
		            <i>Cowles Gym seems to be haunted by many different entities. Our hunters preformed multiple overnight investigations in the gym and discovered several anomalous occurrences. Many others remain as rumors and are currently unconfirmed.</i>
		            <br><br>
		            <h4>Paranormal Entity: The Softball Ghost</h4>
		            ...
		            <table class="table col-8">
		                <thead>
		                    ...
		                    <tr>
		                        <td>10:00 - 11:00</td>
		                        <td>6 Softballs, 1 Bat</td>
		                    </tr>
		                </thead>
		            </table>
		            <br>
		            <h4>Paranormal Entity: The Screaming Ghost</h4>
		            ...
		            <br><br>
		            <h4>Unconfirmed Rumor: Down in the Dungeon</h4>
		            ...
		            <br>
		            <h4>Unconfirmed Rumor: The Crawler</h4>
		            ...
		            <br><br>
		            <h4>Unconfirmed Rumor: Mildred Hedges</h4>
		            ...
		            <br><br>
		            <h4>Unconfirmed Rumor: The Pulse</h4>
		        	...
		        	<div class="card" style="width: 18rem; float: right; margin-top: 1%; margin-left: 5%; margin-bottom: 2%;">
					  <img class="card-img-top" src="img/dun_long.png" alt="The Dungeon" data-toggle="modal" data-target="#enlargephoto5">
					  <div class="card-body">
					    <p class="card-text">Below the gym lies the dungeon, home to indoor hitting facilities and paranormal creatures.</p>
					     <p class="card-text"><small class="text-muted">Click the picture to enlarge.</small></p>
					  </div>
					</div>

					<div class="modal fade" id="enlargephoto5" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel4" aria-hidden="true">
			 			<div class="modal-dialog modal-dialog-centered modal-lg" role="document">
					    <div class="modal-content">
					      <div class="modal-header">
					        <h5 class="modal-title" id="exampleModalLabel4">The Dungeon</h5>
					        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
					          <span aria-hidden="true">&times;</span>
					        </button>
					      </div>
					      <div class="modal-body">
					      	<img class="rounded col-12" src="img/dun_long.png" alt="The Dungeon">
					      </div>
					    </div>
					  </div>
					</div>
					...
					<div class="card" style="width: 18rem; float: right; margin-top: 1%; margin-left: 5%; margin-bottom: 2%;">
					  <img class="card-img-top" src="img/equip_gate.png" alt="Equipment Gate" data-toggle="modal" data-target="#enlargephoto6">
					  <div class="card-body">
					    <p class="card-text">The equipment gate found in the dungeon.</p>
					     <p class="card-text"><small class="text-muted">Click the picture to enlarge.</small></p>
					  </div>
					</div>


					<div class="modal fade" id="enlargephoto6" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel4" aria-hidden="true">
			 			<div class="modal-dialog modal-dialog-centered modal-lg" role="document">
					    <div class="modal-content">
					      <div class="modal-header">
					        <h5 class="modal-title" id="exampleModalLabel4">Equipment Gate</h5>
					        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
					          <span aria-hidden="true">&times;</span>
					        </button>
					      </div>
					      <div class="modal-body">
					      	<img class="rounded col-12" src="img/equip_gate.png" alt="The Equipment Gate">
					      </div>
					    </div>
					  </div>
					</div>
